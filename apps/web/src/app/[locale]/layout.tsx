/** Locale layout that wires translated messages, workspace session state, and client preferences. */
...
/** Declares the supported statically generated locale segments. */
