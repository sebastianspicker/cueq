...
import { resolveDelegation, transitionWorkflow } from '@cueq/core';
...
import { addHours, appendTrail, isRoleAllowedForType, toIso } from './workflow-utils.js';
...
export async function resolveBaseApprover(
