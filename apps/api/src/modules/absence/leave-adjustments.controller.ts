...
import { CreateLeaveAdjustmentSchema, LeaveAdjustmentQuerySchema } from '@cueq/contracts';
...
import { CreateLeaveAdjustmentDto, LeaveAdjustmentDto } from './absence.dto.js';
