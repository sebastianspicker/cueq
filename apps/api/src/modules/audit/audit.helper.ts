...
import { buildAuditEntry } from '@cueq/domain';
import type { AuditWriterPort } from '../../application/ports/audit-writer.port.js';
 ...
 */
@Injectable()
export class AuditHelper implements AuditWriterPort {
